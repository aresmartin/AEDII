...
public class SolActividad7Test {
    ...
    public void testSumideroVacio() {
        ...
        boolean result = SolActividad7.sumidero(gVacio, v3);
        assertFalse(result);
    }
    @Test
    public void testNoSumidero() {
        System.out.println("sumidero");
        boolean result = SolActividad7.sumidero(g, v3);
        assertFalse(result);
    }
    @Test
    ...
    public void testVacioRegular() {
        ...
        boolean result = SolActividad7.regular(gVacio);
    ...
    public void testNORegular() {
        ...
        boolean result = SolActividad7.regular(g);
        assertEquals(expResult, result);
    }
    @Test
    ...
    public void testEsArborescencia() {
        ...
        Vertice<String> result = SolActividad7.esArborescencia(g);
        assertEquals(expResult, result);   
    }
    @Test
