...
public class Actividad7 {
    ...
    private static <E, T> boolean esCamino(Grafo<E, T> grafo, Vertice<E> origen, Vertice<E> destino, List<Vertice<E>> visitados) {
    ...
    public static <E, T> void profundidad(Grafo<E, T> grafo, Vertice<E> vertice) {
        //Creamos una lista vacia donde se meteran los vertices ya visitados
        List<Vertice<E>> visitados = new ArrayList<Vertice<E>>();
    ...
    private static <E, T> void profundidad2(Grafo<E, T> grafo, Vertice<E> vertice, List<Vertice<E>> visitados) {
 ...
 /*¿Que es lo que hace?: Te devuelve un iterador sobre aquellos vertices a los que no se puede llegar por ningun camino.
    ...
    public static <E, T> Iterator<Vertice<E>> noAlcanzables(Grafo<E, T> grafo, Vertice<E> vertice) {
        ...
        while (itVer.hasNext()) {
            visitados.add(itVer.next()); //Metemos TODOS los vertices del grafo en la lista
        }
    ...
    private static <E, T> Iterator<Vertice<E>> noAlcanzables2(Grafo<E, T> grafo, Vertice<E> vertice, List<Vertice<E>> visitados) {
    ...
    private static <E, T> boolean hayCiclo2(Grafo<E, T> grafo, Vertice<E> vOrigen, Vertice<E> vertice, List<Vertice<E>> visitados) {
        ...
        while (adys.hasNext() && !encontrado) {
            ...
            if (vOrigen.equals(aux)) {
                encontrado = true;
            } else if (!visitados.contains(aux)) {
