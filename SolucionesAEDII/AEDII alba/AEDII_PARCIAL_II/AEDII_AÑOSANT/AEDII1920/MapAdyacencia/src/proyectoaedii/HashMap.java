...
public class HashMap<K, V> implements Map<K, V> {
    ...
    /**
     * Devuelve el numero de pares <K,V> que están guardados en las listas del
     * array.
     *
     * @return
     */
    ...
    /**
     * Este metodo sirve para insertar un nuevo Par<K,V> en el mapa. Primero lo
     * recorre, si encuentra una clave igual, sustituye el valor por el nuevo
    ...
    public void insertar(K clave, V valor) {
        ...
        /**
         * Sino, inserta al final de la lista un nuevo objeto de tipo par con la
         * clave y el valor que pasamos como parametros.
         */
        if (!iguales) {
    ...
    public boolean estaClave(K clave) {
         ...
         * queremos comprobar si se encuentra en el mapa, calculamos la posicion
         * del arrayDeListas en la que se supone que se encuentra la lista en la
         * que tenemosque buscar si esta el par que contiene la clave.
         */
        int dirHash = funcionHash(clave);
        /**
         * Creamos un iterador para recorer la lista de esa posicion.
    ...
    public boolean estaValor(V valor) {
         ...
         * array de listas y la inicializamos 0 que es la primera poscicion del
         * array.
         */
        int i = 0;
        /**
        ...
        Par<K, V> par = null;
        /**
         * Recorremos todas las listas del array, mientras que no encontremos el
         * valor que pasamos como parámetro y tengamos listas para recorrer.
         */
    ...
    /**
     * Elimina el par K clave V valor asociado a la clave dada, si la clave está
     * en el mapa
     *
     * @param clave, la clave del valor
     * @return si la clave está en el mapa, devuelve el valor asociado a esta.
    ...
    public Iterator<K> iteradorClaves() {
        /**
         * Declaramos un vector en el que guardar las claves que recuperamos con
         * el iterador.
         */
        Vector<K> arrayDeClaves = new Vector<>();
        /**
         * Con el bucle for recorremos todas las listas que se almacenan en cada
         * una de las posiciones del arrayDeListas.
         */
        for (int i = 0; i < arrayDeListas.length; i++) {
            ...
            while (it.hasNext()) {
                Par<K, V> par = it.next();
                /**
                 * Recuperamos la clave de cada par y la guardamos en el
                 * arrayDeClaves.
                 */
    ...
    public Iterator<V> iteradorValores() {
        ...
        for (int i = 0; i < arrayDeListas.length; i++) {
            ...
            while (it.hasNext()) {
                Par<K, V> par = it.next();
                /**
                 * Recuperamos el valor de cada par y la guardamos en el
                 * arrayDeValores.
                 */
