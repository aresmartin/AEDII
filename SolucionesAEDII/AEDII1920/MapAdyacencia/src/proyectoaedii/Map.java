...
public interface Map<K,V> {
    /**    
     * @return el tamaño del Mapa como entero
     */
   ...
   //public HashMap();
    ...
    /**
     * Asocia el valor y la clave dados dentro del mapa. Si la clave ya está en el mapa, se sobreescribe el valor
     ...
     * @return true si hay claves asociadas al valor, false si no
     */
