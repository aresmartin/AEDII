 ...
 */
package Actividad8Test;

import actividad8.Prueba;
import grafo.*;
import mapa.*;
import lista.*;
...
private static int [] v = {9,7,5,4,3,2,1,3,4,7};
...
return false;
    ...
    public void testDarCambio_int_Map() {
        ...
        Map<Integer, Integer> mapaActual = Prueba.darCambio(1200, can);
    ...
    public void testDarCambio_3args() {
        ...
        Prueba.darCambio(2100, can, mapaActual);
    ...
    public void testLlenarMochila_3args() {
        ...
        Map<String,Integer> mapaActual = Prueba.llenarMochila(55, cantidades, volumenes);
    ...
    public void testLlenarMochila_5args() {
        ...
        Map<String, Integer> mapaActual = Prueba.llenarMochila2(55, 50, cantidades, volumenes, pesos);
    ...
    Grafo<Integer, Integer> grafoActual = Prueba.viajante(g1, uno);
    ...
    public void testPrim() {
        ...
        Grafo<Integer, Integer> grafoActual = Prueba.prim(g1, seis);
        Grafo<Integer, Integer> grafoEsperado = new ListaAdyacencia<>();
    ...
    public void testDijkstra() {
        ...
        Map<Vertice<Integer>, Integer> grafoActual = Prueba.dijkstra(g1, uno); 
    ...
    public void testColocarReinas() {
        ...
        Prueba.colocarReinas(0, tablero);
    ...
    public void testSubconjuntos() {
        ...
        Prueba.subconjunto(valores, solucion, 12, 0);
    ...
    public void testSeleccionRapida() {
        ...
        int sol = Prueba.SeleccionRapida(selecRapi, 5, 0, selecRapi.length-1);
    ...
    public void testLlenarCD_Voraz() {
        ...
        Lista<String> result = Prueba.llenarCDVoraz(capacidadMaxima, programas);
    ...
    public void testLlenarCDVueltaAtras() {
        ...
        expResult.insertarPrincipio("p2");
        expResult.insertarPrincipio("p1");
        Prueba.llenarCDVueltaAtras(capacidadCD, programas, S);
